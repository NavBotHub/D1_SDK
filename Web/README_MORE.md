...
Use [README.md](README.md) for normal demo operation. Continue with this document when adding more commands, video, telemetry, or production integration behavior.
